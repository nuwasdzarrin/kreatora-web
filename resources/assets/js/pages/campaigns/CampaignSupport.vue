...
export default {
  ...
  mounted() {
    ...
    midtransSnapScript.setAttribute('src', config.isProduction ? production.path : sandbox.path)
    midtransSnapScript.setAttribute('data-client-key', config.isProduction ? production.client_key : sandbox.client_key)
